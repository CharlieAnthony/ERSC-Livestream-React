...
export default function CasterOverlay() {
	...
	useEffect(() => {
		if (sheet) {
			...
			setIsCrossConference(getCell(sheet, "R2") == "Cross Conference");
		}
	}, [sheet]);
	...
	return (
		<>
			...
			<Image src={getCell(sheet, "U3")} alt="Tier Logo" className={styles.tier} width={80} height={92} />
